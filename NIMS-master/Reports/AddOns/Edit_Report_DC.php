...
Editor::inst( $db, 'master_file', 'Shp_Id' )
    ->fields(
       ...
       Field::inst( 'cns_ds_sum.DC_Transit' )
              ->name('DC_Transit'),
       Field::inst( 'cns_ds_sum.DC_High_Bay' )
              ->name('DC_High_Bay'),
       Field::inst( 'cns_ds_sum.DC_Low_Bay' )
              ->name('DC_Low_Bay'),
       Field::inst( 'cns_ds_sum.CDC_Low_Bay' )
              ->name('CDC_Low_Bay'),
       Field::inst( 'cns_ds_sum.CDC_Mixed_Lines' )
              ->name('CDC_Mixed_Lines'),
       ...
       ->leftJoin( 'cns_ds_sum', 'cns_ds_sum.Shp_Id', '=', 'master_file.Shp_Id' )
